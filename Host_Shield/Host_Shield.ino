...
void get_XBOX(uint8_t (&arr)[13])
{
        ...
        if (Xbox.Xbox360Connected)
        {
                ...
                if (Xbox.getAnalogHat(LeftHatX) > 3276.0 || Xbox.getAnalogHat(LeftHatX) < -3276.0)
                {
                ...
                if (Xbox.getAnalogHat(LeftHatY) > 3276.0 || Xbox.getAnalogHat(LeftHatY) < -3276.0)
                {
                ...
                if (Xbox.getAnalogHat(RightHatX) > 3276.0 || Xbox.getAnalogHat(RightHatX) < -3276.0)
                {
                ...
                if (Xbox.getAnalogHat(RightHatY) > 3276.0 || Xbox.getAnalogHat(RightHatY) < -3276.0)
                {
